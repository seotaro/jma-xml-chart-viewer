...
export const settings = {
    ...
    chart: {
        '等圧線': { color: [222, 222, 222], textColor: [192, 192, 192], textSize: 14, lineWidth: 2, isStroke: true },
        '等圧線（主線）': { color: [222, 222, 222], textColor: [192, 192, 192], textSize: 14, lineWidth: 4, isStroke: true },
        '等圧線（補助）': { color: [222, 222, 222], textColor: [192, 192, 192], textSize: 14, lineWidth: 2, isStroke: true, },
        ...
        '台風': { iconSize: 40, textColor: [192, 192, 192], textSize: 14, textOffset: [0, 20] },
        '高気圧': { iconSize: 40, textColor: [192, 192, 192], textSize: 14, textOffset: [0, 20] },
        '低気圧': { iconSize: 40, textColor: [192, 192, 192], textSize: 14, textOffset: [0, 20] },
        '熱帯低気圧': { iconSize: 40, textColor: [192, 192, 192], textSize: 14, textOffset: [0, 20] },
        '低圧部': { iconSize: 40, textColor: [192, 192, 192], textSize: 14, textOffset: [0, 20] },
        '悪天情報（強風）': { iconSize: 40 },
