...
export const settings = {
    ...
    chart: {
        ...
        '台風': { text: '台', color: [255, 0, 0], iconSize: 10, textSize: 25 },
        '高気圧': { text: '高', color: [0, 0, 255], iconSize: 10, textSize: 25 },
        '低気圧': { text: '低', color: [255, 0, 0], iconSize: 10, textSize: 25 },
        '熱帯低気圧': { text: '熱', color: [255, 0, 0], iconSize: 10, textSize: 25 },
        '低圧部': { text: '低', color: [255, 0, 0], iconSize: 10, textSize: 25 },
